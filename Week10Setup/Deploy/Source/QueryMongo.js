 ...
 * Modified by Chelsa Hiatt 3/16/14
 */

//define(function(require) {'use strict';
define(['jquery', 'mongodb'], function(j, mongodb) {'use strict';
//define('mongodb', function() {'use strict';
	...
	var QueryMongo = (function() {'use strict';
		...
		var database = null;
		var url = null;
		var collectionName = 'CopyToS3';	// default
		/*
		...
		function QueryMongo() {
			...
			url = urls[1];
			collectionName = 'CopyToS3';	// or change from default
		}
